...
public class Evaluator {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        for (int i = 0; i < args.length;) {
            ...
            } else if (args[i].startsWith("-Glove")) {
        ...
        if (GloveFormat) {
            File Results = new File(outputdir);
            PrintWriter ResPw = new PrintWriter(Results);
...
//  String file2_name=new char[max_size];
                ...
                f = new File(embeddingsDir);
                f2 = new File(benchmarkDir);
                ...
                for (b = 0; b < words; b++) {
                    ...
                    for (a = 0; a < size; a++) {
                        m[b][a] = Double.valueOf(splited[a + 1]);
                    }
                    len = 0;
                    for (a = 0; a < size; a++) {
                        len += m[b][a] * m[b][a];
...
//      if (feof(stdin)) break;
                    ...
                    ArrayList<Double[]> listofVector = new ArrayList<>();
                    ...
                    Double[] taregetVec = new Double[size];
